...
export const templates: Partitions<(s: S) => string> | any = {
    ...
    invalid: (s: S) => `
        ...
        ძალიან კარგია, რომ პირველი დავალება დროულად ატვირთე, მაგრამ დავალების ფაილს არასწორი სახელი აქვს. 
    ...
    error: (s: S) => `
        ...
        ძალიან კარგია, რომ პირველი დავალება დროულად ატვირთე, ფაილის წესებიც სრულყოფილად გაქვს დაცული, მაგრამ 
    ...
    failed: (s: S) => `
        ...
        ძალიან კარგია, რომ პირველი დავალება დროულად ატვირთე, ფაილის წესებიც სრულყოფილად გაქვს დაცული და კოდშიც
    ...
    passed: (s: S) => `
        ...
        გილოცავ პირველი დავალების ჩაბარებას. ყველაფერი სწორად გააკეთე :) 

        კარგია, რომ დროულად დაიწყე მუშაობა და იმედი მაქვს ამ მნიშვნელოვან ჩვევას მაქსიმალურად შეინარჩუნებ.

        წარმატებები ყველა სხვა დავალებაშიც!
