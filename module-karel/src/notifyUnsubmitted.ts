...
const templates = {
	...
	`,
	notSubmitted: (s: S) => `
		<p>დედლაინამდე მხოლოდ ერთი დღეა დარჩენილი (ორშაბათი 23:59) და პროექტი ჯერ კიდევ არ გაქვს გამოგზავნილი. დღეიდან ფაილების 
		ვალიდურობას ისევ სერვერი შეამოწმებს, დავალებებზე უფრო ხშირი პერიოდულობით (10-15 წუთი). 
		მე სამშაბათამდე ხაზზე არ ვარ და ვეღარ შევძლებ დახმარებას.</p>
		...
		დაიწყებთ ფაილების ატვირთვას.</strong></p> 
